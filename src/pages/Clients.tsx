  ...
  return (
    <RootLayout>
      <div className="flex-1">
        <div className="w-full flex flex-col gap-10 px-4 py-6">
          <div className="w-full flex items-center justify-between">
            ...
            <div className="flex gap-4 items-center">
              <img
                className="cursor-pointer h-[16px] w-[16px] object-contain hidden lg:flex"
                src={data.icons.searchIcon}
                alt="Search Icon"
              />
              <img
                className="cursor-pointer h-[16px] w-[16px] object-contain  hidden lg:flex"
              ...
              <div className="flex items-center gap-2">
                <p className="text-white text-sm font-medium cursor-pointer hidden md:flex">
                  Jaques Kagabo
                </p>
                <img
                  src={data.images.person1}
                  alt="Profile image"
                  className="h-6 w-6 object-contain rounded-full cursor-pointer"
                />
              </div>
            </div>
          </div>
          ...
          <div className="w-full flex justify-center  flex-col gap-4">
            <div className="w-full flex flex-col gap-2 items-center">
              ...
              <div className="w-full md:w-[50%] flex flex-col gap-2 items-center">
                <div className="w-full flex items-start justify-between px-3">
                  <p className="text-gray-400 text-sm md:text-lg">
                    Add a new client
                  </p>
                  <div className="px-2 bg-gray-400 flex items-center justify-center cursor-pointer rounded-lg">
                    <p
                      onClick={handleToggleOpenAndCloseModal}
            ...
            <div className="w-full h-auto bg-white py-5 rounded-lg flex flex-col gap-4">
              ...
              <table className="w-full hidden md:table">
                <thead className="w-full">
                  <tr className="flex items-center justify-start px-10 py-2 border-b-[1.5px] border-gray-400">
                ...
                <tbody>
                  {data.clients.map((client, idx) => (
                    <tr
                      key={idx}
                      className="w-full flex items-center justify-start px-10 py-2 border-b-[1.5px] border-gray-400"
                    >
                      ...
                      <td className="text-start flex-2">
                        <div className="block">
                          <p>{client.sales} Frw</p>
                          <p className="text-xs text-gray-500">on 24.05.2019</p>
                        </div>
                      </td>
                      <td className="flex-1">
                      ...
                      <td className="text-start flex-1">
                        <div className="flex items-center justify-between">
                          ...
                          <p className="text-zinc-400 text-lg cursor-pointer">
                            ...
                          </p>
                        </div>
                      </td>
              ...
              {/* CARD VIEW*/}
              <div className="md:hidden space-y-4 w-full px-3">
                {data.clients.map((client, idx) => (
                  <div
                    key={idx}
                    className="bg-white rounded-lg shadow border px-4 py-3 flex flex-col gap-2"
                  >
                    <div>
                    ...
                    <div>
                      <p className="text-sm">{client.sales} Frw</p>
                      <p className="text-xs text-gray-500">on 24.05.2019</p>
                    </div>
              ...
              <div className="mt-10 lg:mt-20 flex items-center justify-center lg:justify-end px-6">
                <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-12 w-full sm:w-auto">
        ...
        {isModalVisible && (
          <AddClientModal onClose={handleToggleOpenAndCloseModal} />
        )}
      </div>
    </RootLayout>
  );
